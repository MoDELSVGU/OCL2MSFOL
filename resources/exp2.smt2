...
(assert (or (and (= caller nullClassifier) (= self nullClassifier)) (and (= caller self) (not (or (= caller nullClassifier) (= caller invalidClassifier) (= self nullClassifier) (= self invalidClassifier))))))
(check-sat)
